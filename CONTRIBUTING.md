# Contributing to gotth-pg-migrate

Development is canonical on Forgejo:

- Source and issue tracker: <https://git.dannyhunn.com/agents/gotth-pg-migrate>
- Public distribution mirror: <https://github.com/gotthboard/gotth-pg-migrate>
