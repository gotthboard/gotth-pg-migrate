...
- Canonical development and change tracking:
  <https://git.dannyhunn.com/agents/gotth-pg-migrate>
- Public clone, Go import, and future releases:
  <https://github.com/gotthboard/gotth-pg-migrate>
...
Current status: unreleased Go library; PostgreSQL 17 is the current compatibility target.
...
```go
import migration "github.com/gotthboard/gotth-pg-migrate"
```
